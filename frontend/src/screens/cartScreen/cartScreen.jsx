    ...
    <Row className="cart-screen-wrapper screen">
      <Col md={8}>
        ...
        {cartItems.length === 0 ? (
          ...
          <ListGroup
            variant="flush"
            className="product-screen-card product-card"
          >
            {cartItems.map((item) => (
                ...
                <Row className="cart-item">
                  ...
                  <Col md={2}>
                    <Button
                      type="button"
                      variant="light"
                      className="card-button-style-without-radius"
      ...
      <Col md={4}>
        <Card className="card-style product-screen-card">
